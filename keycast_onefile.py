...
try:
    ...
    path_to_assets = path.join(bundle_dir, 'assets', 'icons', 'cross', 'times_solid_20_white.png')
    cross_btn_image = tk.PhotoImage(file=path_to_assets)
except:
    print('exception')
    cross_btn_image = tk.PhotoImage(file='./assets/icons/cross/times_solid_20_white.png')
